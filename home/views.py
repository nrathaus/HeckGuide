...
def Prices(request):
    return render(
        ...
        "prices.html",
        {
            "prices_1": settings.PRICES_1,
            "prices_2": settings.PRICES_2,
            "prices_3": settings.PRICES_3,
            "prices_4": settings.PRICES_4,
            "prices_5": settings.PRICES_5,
            "prices_6": settings.PRICES_6,
...
def TokenCalculatorView(request):
    if request.method == "POST":
        ...
        return render(
            request,
            "calculators/TokenCalculator.html",
            {
                "form": form,
                "token1": token1,
                "token2": token2,
...
def BrewCalculatorView(request):
    if request.method == "POST":
        ...
        return render(
            request,
            "calculators/BrewCalculator.html",
            {
                "form": form,
                "token1": token1,
                "token2": token2,
...
def AllyStatView(request):
    ...
    if request.method == "POST":
        ...
        return render(
            request,
            "calculators/AllyStatCalculator.html",
            {
                "form": form,
                "price": price,
                "biome": biome,
                ...
                "badlands": badlands,
                "swamplands": swamplands,
                "target": target,
                "target2": target2,
                "grasslands2": grasslands2,
                "badlands2": badlands2,
                "swamplands2": swamplands2,
                "total": total,
                "total2": total2,
            },
        )
        ...
        return render(
            request,
            "calculators/AllyStatCalculator.html",
            {"form": form, "target": target, "target2": target2},
        )
...
def RallyCalculatorView(request):
    if request.method == "POST":
        ...
        return render(
            request,
            "calculators/RallyCalculator.html",
            {"form": form, "joiners": joiners, "totalrally": totalrally},
        )
    else:
...
def MasteryCalculatorView(request):
    if request.method == "POST":
        ...
        return render(
            request,
            "calculators/MasteryCalculator.html",
            {
                "form": form,
                "xpgold": xpgold,
                ...
                "defgold": defgold,
                "statsforalliesgold": statsforalliesgold,
                "bonusforalliesgold": bonusforalliesgold,
                "marchboostgold": marchboostgold,
                "abilityboostgold": abilityboostgold,
                "marchgold2": marchgold2,
                "totalgold": totalgold,
                "totalfood": totalfood,
                "totalore": totalore,
            },
